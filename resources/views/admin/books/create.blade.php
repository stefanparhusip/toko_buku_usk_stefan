@extends('admin.layouts.app', ['title' => 'Tambah Book'])
            ...
            <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="publisher" name="publisher" class="form-control @error('publisher') is-invalid @enderror" value="{{ old('publisher') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="price" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" min="0" required>
                        @error('price')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4">
                        <label for="stock" class="form-label">Stock</label>
                        <input type="number" id="stock" name="stock" class="form-control @error('stock') is-invalid @enderror" value="{{ old('stock') }}" min="0" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Opsi 1: upload file gambar.</small>
                        @error('image')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6">
                        <label for="image_url" class="form-label">Image Address (URL)</label>
                        <input type="url" id="image_url" name="image_url" class="form-control @error('image_url') is-invalid @enderror" value="{{ old('image_url') }}" placeholder="https://example.com/cover.jpg">
                        <small class="text-muted">Opsi 2: isi link gambar jika tidak upload file.</small>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_recommended" name="is_recommended" value="1" @checked(old('is_recommended'))>
                                <label class="form-check-label" for="is_recommended">Rekomendasi</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_new" name="is_new" value="1" @checked(old('is_new'))>
                ...
                <button type="submit" class="btn btn-navy mt-4">Simpan</button>
            </form>
        </div>
    </div>
@endsection
